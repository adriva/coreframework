...
namespace Adriva.Extensions.Reporting.Abstractions
{
    ...
    public class DataSet
    {
        ...
        public ReadOnlyCollection<DataColumn> Columns => new(this.DataColumns);

        public ReadOnlyCollection<DataRow> Rows => new(this.DataRows);
        ...
        public static DataSet FromColumnNames(params string[] names)
        {
            ...
            return DataSet.FromFields([.. names.Select(n => new FieldDefinition() { Name = n })]);
        }
