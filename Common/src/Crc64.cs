...
namespace Adriva.Common.Core
{
    public static class Crc64
    {
        ...
        /// <summary>
        /// Computes the 64 bit CRC value for a given string.
        /// </summary>
        /// <param name="text">The string, for which the CRC value will be computed for.</param>
        /// <returns>0 if the given string is Empty or Null, otherwise an unsigned 64 bit integer representing the CRC value.</returns>
        ...
        /// <summary>
        /// Computes the 64 bit CRC value for a given byte array.
        /// </summary>
        /// <param name="data">The byte array, for which the CRC value will be computed for.</param>
        /// <returns>0 if the given array is Null, otherwise an unsigned 64 bit integer representing the CRC value.</returns>
