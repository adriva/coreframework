...
namespace Adriva.Extensions.Faster
{
    ...
    public class FasterException : Exception
    {
        ...
        protected FasterException(SerializationInfo info, StreamingContext context) : base(info, context) { }
    }
    ...
    public class FasterConflictException : FasterException
    {
        ...
        protected FasterConflictException(SerializationInfo serializationInfo, StreamingContext streamingContext)
