...
{
    internal class SqlServerQueueClient : IQueueClient, IAsyncInitializedStorageClient<SqlServerQueueOptions>
    {
        ...
        public async ValueTask InitializeAsync(SqlServerQueueOptions options)
        {
        ...
        public async ValueTask AddAsync(QueueMessage message, TimeSpan? timeToLive = null, TimeSpan? visibilityTimeout = null, TimeSpan? initialVisibilityDelay = null)
        {
            ...
            entity.Environment = this.Options.EnvironmentName;
        ...
        {
            var messageEntity = await this.QueueDbHelper.GetNextAsync(this.Options.EnvironmentName, cancellationToken);
