...
namespace Adriva.Storage.Abstractions
{
    public interface ITableClient : IStorageClient
    {
        ...
        Task<SegmentedResult<TItem>> SelectAsync<TItem>(FormattableString formattableQuery, string continuationToken = null, int rowCount = 500) where TItem : class;
        ...
        Task BatchDeleteAsync(string partitionKey);
