...
namespace Adriva.Extensions.Caching.SqlServer
{
    internal class DatabaseOperations : IDatabaseOperations
    {
        ...
        public DatabaseOperations(string connectionString, string schemaName, string tableName, string dependencyTableName)
        {
            ConnectionString = connectionString;
            SchemaName = schemaName;
            TableName = tableName;
            SqlQueries = new SqlQueries(schemaName, tableName, dependencyTableName);
        }
